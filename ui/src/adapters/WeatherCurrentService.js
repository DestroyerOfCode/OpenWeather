...
export function retrieveAllWeathers(sortBy, isAscending, filters, currentPage, itemsPerPage) {
	return axios.post(`${apiConstants.WEATHER_CURRENT_API_URL}/retrieve/fromDb`, {
		sortBy: sortBy,
